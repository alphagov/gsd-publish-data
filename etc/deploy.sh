...
docker build --file=$DOCKER_FILE --build-arg SECRET_KEY_BASE=$APP_SECRET_KEY_BASE --build-arg NOTIFY_API_KEY=$NOTIFY_API_KEY --tag=$DOCKER_REPOSITORY/$DOCKER_IMAGE:$TRAVIS_BUILD_NUMBER .
